...
database = ms.database.JSONDatabase(
            path_workload="e2e_mlp/database_workload.json",
            path_tuning_record="e2e_mlp/database_tuning_record.json",
)
with database, target:
    relax_mod = relax.transform.MetaScheduleApplyDatabase(enable_warning=True)(relax_mod)
write_mod(relax_mod, log_path, "MetaScheduleApplyDatabase")
