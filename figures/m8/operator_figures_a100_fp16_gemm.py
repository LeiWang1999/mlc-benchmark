...
plt.savefig(f"pdf/op_benchmark_a100_fp16_gemm_e{num_ops}.pdf", bbox_inches='tight')
plt.savefig(f"png/op_benchmark_a100_fp16_gemm_e{num_ops}.png",  bbox_inches='tight', transparent=False, dpi=255)
