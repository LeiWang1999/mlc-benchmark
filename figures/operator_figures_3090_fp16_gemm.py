...
plt.savefig("pdf/op_benchmark_3090_fp16_gemm.pdf", bbox_inches='tight')
plt.savefig("png/op_benchmark_3090_fp16_gemm.png",  bbox_inches='tight', transparent=False, dpi=255)
